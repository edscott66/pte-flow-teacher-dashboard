          ...
          <nav className="sidebar-links">
            ...
            {role === "teacher" && (
              <>
                ...
                <NavLink to="/master-teacher" className={({ isActive }) => (isActive ? "active" : "")}>
                  <span className="sidebar-icon" style={{ color: "#14b8a6", fontSize: "22px" }}>🎓</span>
                  <span>PTE Master Teacher</span>
                </NavLink>
              </>
            )}
